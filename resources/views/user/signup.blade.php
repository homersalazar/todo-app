    ...
    <div class="flex flex-row w-full h-screen p-5 gap-5">
        ...
        <div class="flex flex-col w-full items-center justify-center gap-5">
            <form class="w-1/2 mx-auto space-y-6">
                ...
                <div class="mb-5">
                    <input type="password" id="confirm_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Confirm password" required />
                </div>
                ...
                <div class="flex flex-row w-full gap-5">
                    <button type="button" class="justify-center text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 w-full">
                    ...
                    <button type="button" class="justify-center text-white bg-[#3b5998] hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2 w-full">
