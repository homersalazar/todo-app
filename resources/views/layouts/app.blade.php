...
<html lang="en">
    ...
    <body>
        {{-- @auth --}}
            ...
            <aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-72 h-screen transition-transform -translate-x-full sm:translate-x-0 text-sm" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50">
                    <ul class="space-y-2 font-medium">
                        ...
                        <li class="flex flex-row flex-wrap gap-3">
                            <span class="bg-blue-300 text-xs font-medium px-2.5 py-0.5 rounded-sm">TAG 1</span>
                            <span class="bg-green-300 text-xs font-medium px-2.5 py-0.5 rounded-sm">TAG 2</span>
                            <span class="bg-red-300 text-xs font-medium px-2.5 py-0.5 rounded-sm">TAG 3</span>
                            <span class="bg-orange-300 text-xs font-medium px-2.5 py-0.5 rounded-sm">TAG 4</span>
                            <span class="bg-gray-300 text-xs font-medium px-2.5 py-0.5 rounded-sm">+ Add Tag</span>
                        </li>
                        <li class="pt-5">
